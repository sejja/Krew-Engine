...
#define FMOD_VERSION    0x00011002
...
typedef FMOD_RESULT(F_CALLBACK* FMOD_SOUND_NONBLOCK_CALLBACK)  (FMOD_SOUND* mSound, FMOD_RESULT result);
typedef FMOD_RESULT(F_CALLBACK* FMOD_SOUND_PCMREAD_CALLBACK)   (FMOD_SOUND* mSound, void* data, unsigned int datalen);
typedef FMOD_RESULT(F_CALLBACK* FMOD_SOUND_PCMSETPOS_CALLBACK) (FMOD_SOUND* mSound, int subsound, unsigned int position, FMOD_TIMEUNIT postype);
