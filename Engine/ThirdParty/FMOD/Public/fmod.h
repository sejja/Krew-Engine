...
extern "C"
{
	...
	*/
	...
	FMOD_RESULT F_API FMOD_System_SetPluginPath(FMOD_SYSTEM* system, const char* mPath);
	...
	*/
	...
	FMOD_RESULT F_API FMOD_System_CreateSound(FMOD_SYSTEM* system, const char* name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO* exinfo, FMOD_SOUND** mSound);
	FMOD_RESULT F_API FMOD_System_CreateStream(FMOD_SYSTEM* system, const char* name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO* exinfo, FMOD_SOUND** mSound);
	...
	FMOD_RESULT F_API FMOD_System_PlaySound(FMOD_SYSTEM* system, FMOD_SOUND* mSound, FMOD_CHANNELGROUP* channelgroup, FMOD_BOOL paused, FMOD_CHANNEL** channel);
	...
	*/
	...
	FMOD_RESULT F_API FMOD_System_RecordStart(FMOD_SYSTEM* system, int id, FMOD_SOUND* mSound, FMOD_BOOL loop);
	...
	*/
	...
	FMOD_RESULT F_API FMOD_Sound_Release(FMOD_SOUND* mSound);
	FMOD_RESULT F_API FMOD_Sound_GetSystemObject(FMOD_SOUND* mSound, FMOD_SYSTEM** system);

	/*
		 Standard sound manipulation functions.
	*/

	FMOD_RESULT F_API FMOD_Sound_Lock(FMOD_SOUND* mSound, unsigned int offset, unsigned int length, void** ptr1, void** ptr2, unsigned int* len1, unsigned int* len2);
	FMOD_RESULT F_API FMOD_Sound_Unlock(FMOD_SOUND* mSound, void* ptr1, void* ptr2, unsigned int len1, unsigned int len2);
	FMOD_RESULT F_API FMOD_Sound_SetDefaults(FMOD_SOUND* mSound, float frequency, int priority);
	FMOD_RESULT F_API FMOD_Sound_GetDefaults(FMOD_SOUND* mSound, float* frequency, int* priority);
	FMOD_RESULT F_API FMOD_Sound_Set3DMinMaxDistance(FMOD_SOUND* mSound, float min, float max);
	FMOD_RESULT F_API FMOD_Sound_Get3DMinMaxDistance(FMOD_SOUND* mSound, float* min, float* max);
	FMOD_RESULT F_API FMOD_Sound_Set3DConeSettings(FMOD_SOUND* mSound, float insideconeangle, float outsideconeangle, float outsidevolume);
	FMOD_RESULT F_API FMOD_Sound_Get3DConeSettings(FMOD_SOUND* mSound, float* insideconeangle, float* outsideconeangle, float* outsidevolume);
	FMOD_RESULT F_API FMOD_Sound_Set3DCustomRolloff(FMOD_SOUND* mSound, FMOD_VECTOR* points, int numpoints);
	FMOD_RESULT F_API FMOD_Sound_Get3DCustomRolloff(FMOD_SOUND* mSound, FMOD_VECTOR** points, int* numpoints);
	FMOD_RESULT F_API FMOD_Sound_GetSubSound(FMOD_SOUND* mSound, int index, FMOD_SOUND** subsound);
	FMOD_RESULT F_API FMOD_Sound_GetSubSoundParent(FMOD_SOUND* mSound, FMOD_SOUND** parentsound);
	FMOD_RESULT F_API FMOD_Sound_GetName(FMOD_SOUND* mSound, char* name, int namelen);
	FMOD_RESULT F_API FMOD_Sound_GetLength(FMOD_SOUND* mSound, unsigned int* length, FMOD_TIMEUNIT lengthtype);
	FMOD_RESULT F_API FMOD_Sound_GetFormat(FMOD_SOUND* mSound, FMOD_SOUND_TYPE* type, FMOD_SOUND_FORMAT* format, int* channels, int* bits);
	FMOD_RESULT F_API FMOD_Sound_GetNumSubSounds(FMOD_SOUND* mSound, int* numsubsounds);
	FMOD_RESULT F_API FMOD_Sound_GetNumTags(FMOD_SOUND* mSound, int* numtags, int* numtagsupdated);
	FMOD_RESULT F_API FMOD_Sound_GetTag(FMOD_SOUND* mSound, const char* name, int index, FMOD_TAG* tag);
	FMOD_RESULT F_API FMOD_Sound_GetOpenState(FMOD_SOUND* mSound, FMOD_OPENSTATE* openstate, unsigned int* percentbuffered, FMOD_BOOL* starving, FMOD_BOOL* diskbusy);
	FMOD_RESULT F_API FMOD_Sound_ReadData(FMOD_SOUND* mSound, void* buffer, unsigned int length, unsigned int* read);
	FMOD_RESULT F_API FMOD_Sound_SeekData(FMOD_SOUND* mSound, unsigned int pcm);

	FMOD_RESULT F_API FMOD_Sound_SetSoundGroup(FMOD_SOUND* mSound, FMOD_SOUNDGROUP* soundgroup);
	FMOD_RESULT F_API FMOD_Sound_GetSoundGroup(FMOD_SOUND* mSound, FMOD_SOUNDGROUP** soundgroup);

	/*
		 Synchronization point API.  These points can come from markers embedded in wav files, and can also generate channel callbacks.
	*/

	FMOD_RESULT F_API FMOD_Sound_GetNumSyncPoints(FMOD_SOUND* mSound, int* numsyncpoints);
	FMOD_RESULT F_API FMOD_Sound_GetSyncPoint(FMOD_SOUND* mSound, int index, FMOD_SYNCPOINT** point);
	FMOD_RESULT F_API FMOD_Sound_GetSyncPointInfo(FMOD_SOUND* mSound, FMOD_SYNCPOINT* point, char* name, int namelen, unsigned int* offset, FMOD_TIMEUNIT offsettype);
	FMOD_RESULT F_API FMOD_Sound_AddSyncPoint(FMOD_SOUND* mSound, unsigned int offset, FMOD_TIMEUNIT offsettype, const char* name, FMOD_SYNCPOINT** point);
	FMOD_RESULT F_API FMOD_Sound_DeleteSyncPoint(FMOD_SOUND* mSound, FMOD_SYNCPOINT* point);

	/*
		 Functions also in Channel class but here they are the 'default' to save having to change it in Channel all the time.
	*/

	FMOD_RESULT F_API FMOD_Sound_SetMode(FMOD_SOUND* mSound, FMOD_MODE mode);
	FMOD_RESULT F_API FMOD_Sound_GetMode(FMOD_SOUND* mSound, FMOD_MODE* mode);
	FMOD_RESULT F_API FMOD_Sound_SetLoopCount(FMOD_SOUND* mSound, int loopcount);
	FMOD_RESULT F_API FMOD_Sound_GetLoopCount(FMOD_SOUND* mSound, int* loopcount);
	FMOD_RESULT F_API FMOD_Sound_SetLoopPoints(FMOD_SOUND* mSound, unsigned int loopstart, FMOD_TIMEUNIT loopstarttype, unsigned int loopend, FMOD_TIMEUNIT loopendtype);
	FMOD_RESULT F_API FMOD_Sound_GetLoopPoints(FMOD_SOUND* mSound, unsigned int* loopstart, FMOD_TIMEUNIT loopstarttype, unsigned int* loopend, FMOD_TIMEUNIT loopendtype);

	/*
		 For MOD/S3M/XM/IT/MID sequenced formats only.
	*/

	FMOD_RESULT F_API FMOD_Sound_GetMusicNumChannels(FMOD_SOUND* mSound, int* numchannels);
	FMOD_RESULT F_API FMOD_Sound_SetMusicChannelVolume(FMOD_SOUND* mSound, int channel, float volume);
	FMOD_RESULT F_API FMOD_Sound_GetMusicChannelVolume(FMOD_SOUND* mSound, int channel, float* volume);
	FMOD_RESULT F_API FMOD_Sound_SetMusicSpeed(FMOD_SOUND* mSound, float speed);
	FMOD_RESULT F_API FMOD_Sound_GetMusicSpeed(FMOD_SOUND* mSound, float* speed);

	/*
		 Userdata set/get.
	*/

	FMOD_RESULT F_API FMOD_Sound_SetUserData(FMOD_SOUND* mSound, void* userdata);
	FMOD_RESULT F_API FMOD_Sound_GetUserData(FMOD_SOUND* mSound, void** userdata);
	...
	*/
	...
	FMOD_RESULT F_API FMOD_Channel_GetCurrentSound(FMOD_CHANNEL* channel, FMOD_SOUND** mSound);
	...
	*/
	...
	FMOD_RESULT F_API FMOD_SoundGroup_GetSound(FMOD_SOUNDGROUP* soundgroup, int index, FMOD_SOUND** mSound);
