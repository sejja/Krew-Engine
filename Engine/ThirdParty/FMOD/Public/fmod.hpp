...
namespace FMOD
{
	...
	*/
	...
	public:
		...
		FMOD_RESULT F_API createSound(const char* name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO* exinfo, Sound** mSound);
		FMOD_RESULT F_API createStream(const char* name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO* exinfo, Sound** mSound);
		...
		FMOD_RESULT F_API playSound(Sound* mSound, ChannelGroup* channelgroup, bool paused, Channel** channel);
		...
		FMOD_RESULT F_API recordStart(int id, Sound* mSound, bool loop);
	...
	*/
	...
	public:
		...
		FMOD_RESULT F_API getCurrentSound(Sound** mSound);
	...
	*/
	...
	public:
		...
		FMOD_RESULT F_API getSound(int index, Sound** mSound);
